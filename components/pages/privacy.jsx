export default function Privacy() {
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <p>⊳ You have to vote for the <a className="text-white" href="https://discord.gg/HwWvENNqpN">MusicMaker</a> bot when using certain commands from the bot commands.</p>
        <div className="py-3"></div>
